...
class AppGUI:
    ...
    def _create_main_frame(self):
        ...
        report_button.place(relx=0.98, rely=0.06, anchor="ne")
    ...
    def _create_stock_tab(self):
        ...
        self.stock_tree.bind("<Double-1>", lambda event: self._edit_record(event, self.stock_tree, "products", "product_id"))
    ...
    def _create_orders_tab(self):
        ...
        self.orders_tree.bind("<Double-1>", lambda event: self._edit_record(event, self.orders_tree, "orders", "order_id"))
    ...
    def _create_sales_tab(self):
        ...
        self.sales_tree.bind("<Double-1>", lambda event: self._edit_record(event, self.sales_tree, "sales", "sale_id"))
    ...
    def _open_reports_window(self):
         if self.report_window is None or not tk.Toplevel.winfo_exists(self.report_window):
             ...
             for col in columns:
               ...
               report_tree.column(col, width=200, anchor='center') # Выравнивание текста в столбце
             ...
             tk.Button(report_frame, text="Назад к производству", command=reports_window.destroy).pack(padx=10, pady=10, anchor="se", side="right")
    ...
    def _reset_auto_increment(self, table):
